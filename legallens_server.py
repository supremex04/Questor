...
# llama_parse_documents = LlamaParse(api_key=os.getenv("LLAMA_PARSE_API_KEY"), result_type="markdown").load_data(["./references/legallens/Constitution-of-Nepal.pdf", "./references/legallens/Federal_Budget_2081_82.pdf"])
