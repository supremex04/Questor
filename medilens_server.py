...
# llama_parse_documents = LlamaParse(api_key=os.getenv("LLAMA_PARSE_API_KEY"), result_type="markdown").load_data(["./references/medilens/cardio_vascular2.pdf", "./references/medilens/cardiology-explained.pdf"])
